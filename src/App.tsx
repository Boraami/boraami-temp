      ...
      <div className="hero">
        <main>
          <figure className="screenshot">
            <img 
              src="public/blu-app.png" 
              alt="Blu with Boraami App Screenshots" 
            />
          </figure>
          ...
          <div className="content">
            ...
            <p>
              A safe and inclusive social media app for{" "}
              <span className="bold">ARMY</span> to stay connected, and support all the{" "}
              <span className="bold">BTS</span> members
            </p>
            ...
            <div className="socials">
              ...
              <div className="social-media-icons">
                <SocialLink 
                  link="https://twitter.com/boraami_app" 
                  icon={<XIcon />} 
                />
                <SocialLink 
                ...
                />
                <SocialLink 
                  link="https://www.tiktok.com/@boraami_app" 
                  icon={<TiktokIcon />} 
                />
                <SocialLink 
                  link="https://bsky.app/profile/boraami.app" 
                  icon={<BlueskyIcon />} 
                />
                <SocialLink 
      ...
      <div className="sections">
        ...
        <section className="support">
          ...
          <p>
            ...
            <a 
              href="mailto:support@boraami.app" 
              target="_blank"
              rel="noopener noreferrer"
            >
              support@boraami.app
